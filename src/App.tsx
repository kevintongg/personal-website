          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card className="group overflow-hidden transition-shadow hover:shadow-lg dark:hover:shadow-gray-800/25">
              <div className="flex h-48 w-full items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600">
                <span className="text-lg font-semibold text-white">Project Preview</span>
              </div>
              <CardHeader>
            ...
            {/* Project 2 */}
            <Card className="group overflow-hidden transition-shadow hover:shadow-lg dark:hover:shadow-gray-800/25">
              <div className="flex h-48 w-full items-center justify-center bg-gradient-to-br from-green-500 to-teal-600">
                <span className="text-lg font-semibold text-white">Project Preview</span>
              </div>
              <CardHeader>
            ...
            {/* Project 3 */}
            <Card className="group overflow-hidden transition-shadow hover:shadow-lg dark:hover:shadow-gray-800/25">
              <div className="flex h-48 w-full items-center justify-center bg-gradient-to-br from-orange-500 to-red-600">
                <span className="text-lg font-semibold text-white">Project Preview</span>
              </div>
              <CardHeader>
                <CardTitle>Weather Dashboard</CardTitle>
                <CardDescription>
                  A beautiful weather dashboard with location-based forecasts and interactive
                  charts.
                </CardDescription>
              </CardHeader>
              <CardContent>
